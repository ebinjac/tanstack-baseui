...
export const updateLink = createServerFn({ method: 'POST' })
  ...
  .handler(async ({ data, context }) => {
    ...
    const updates: Record<string, unknown> = {
      ...updateFields,
      applicationId:
        updateFields.applicationId && updateFields.applicationId !== 'none'
          ? updateFields.applicationId
          : updateFields.applicationId === 'none'
            ? null
            : undefined,
      categoryId:
        updateFields.categoryId && updateFields.categoryId !== 'none'
          ? updateFields.categoryId
          : updateFields.categoryId === 'none'
            ? null
            : undefined,
      updatedBy: userEmail,
      updatedAt: new Date(),
