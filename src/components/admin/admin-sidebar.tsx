            ...
            <SidebarHeader className="border-b border-sidebar-border/50">
                <div className="flex items-center gap-2 px-2 py-1 overflow-hidden">
                    ...
                    <div className="flex flex-col gap-0.5 leading-none min-w-0 overflow-hidden transition-all duration-200 group-data-[collapsible=icon]:w-0 group-data-[collapsible=icon]:opacity-0">
                        <span className="font-bold text-sm tracking-tight whitespace-nowrap">ENSEMBLE</span>
                        <span className="text-[10px] font-medium text-sidebar-foreground/60 uppercase tracking-widest whitespace-nowrap">Admin Portal</span>
                    </div>
                </div>
            </SidebarHeader>
            <SidebarContent>
                                ...
                                return (
                                    <SidebarMenuItem key={item.title}>
                                        <SidebarMenuButton
                                            ...
                                            `}
                                        >
                                            <item.icon className={`h-5 w-5 shrink-0 ${isActive ? 'text-primary' : 'text-sidebar-foreground/70'}`} />
            ...
            <SidebarFooter className="border-t border-sidebar-border/50">
                ...
                <div className="flex items-center gap-2 px-2 py-1 overflow-hidden">
                    ...
                    <div className="flex flex-col gap-0.5 leading-none min-w-0 overflow-hidden transition-all duration-200 group-data-[collapsible=icon]:w-0 group-data-[collapsible=icon]:opacity-0">
                        ...
                        <span className="text-[10px] text-sidebar-foreground/60 truncate">admin@ensemble.app</span>
                    </div>
                    <button
