  ...
  return (
    <>
      <TableRow className="hover:bg-muted/30 group transition-colors">
        <TableCell
          rowSpan={2}
          className="align-top border-r sticky left-0 bg-background/95 backdrop-blur-sm z-10 px-3 py-3 group-hover:bg-muted/20"
        >
          <div className="flex flex-col gap-1 min-w-[130px]">
            ...
            <div className="flex gap-1.5 mt-1">
              <div
                className="flex items-center gap-1 px-1.5 py-0.5 rounded border border-border bg-muted/30 text-[9px] font-bold uppercase tracking-widest text-muted-foreground"
        ...
        {displayMonths.map((monthInfo) => {
          ...
          return (
            <TableCell
              key={key}
              className="p-1 text-center group-hover:bg-muted/10 transition-colors border-b-border/30"
            >
              <DataCell
        ...
        >
          {avgAvailability !== null ? (
            <div className="flex flex-col items-center gap-0.5">
              ...
              {avgAvailBreach && (
                <div className="h-1 w-4 bg-red-500 rounded-full animate-pulse" />
              )}
            </div>
          ) : (
        ...
        {isAdmin && (
          <TableCell
            rowSpan={2}
            className="align-middle text-right pr-6 group-hover:bg-muted/10"
          >
      ...
      <TableRow className="hover:bg-muted/30 group border-b-2 border-b-border/30 transition-colors">
        ...
        {displayMonths.map((monthInfo, index) => {
          ...
          return (
            <TableCell
              key={key}
              className="p-1.5 text-center group-hover:bg-muted/10 transition-colors"
            >
              <DataCell
