        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Visualizing aggregated performance across all applications for {filterLabel}.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-6 py-4">
                    <div className="flex flex-col sm:flex-row justify-between gap-4 items-start sm:items-center bg-muted/40 p-3 rounded-lg border">
                        <Tabs value={chartMetric} onValueChange={(v) => setChartMetric(v as any)} className="w-full sm:w-auto">
                            <TabsList>
                            ...
                            {chartType === 'area' ? (
                                ...
                                >
                                    ...
                                    <YAxis
                                        ...
                                        tickMargin={8}
                                        fontSize={12}
                                        domain={chartMetric === 'availability' ? [90, 100] : ['auto', 'auto']}
                                    />
                                    <ChartTooltip content={<ChartTooltipContent indicator="dot" />} />
                                    <ChartLegend content={<ChartLegendContent />} />
                                    <defs>
                                        <linearGradient id={`${chartMetric}Gradient`} x1="0" y1="0" x2="0" y2="1">
