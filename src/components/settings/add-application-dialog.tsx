  ...
  const searchAsset = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:8008/api/central?assetId=${assetIdSearch}`,
      )
      ...
      if (data?.data?.application) {
        ...
        if (app.ownershipInfo) {
          ...
          setValue(
            'productionSupportOwnerName',
            oi.productionSupportOwner?.fullName,
          )
          setValue(
            'productionSupportOwnerEmail',
            oi.productionSupportOwner?.email,
          )
          setValue(
            'productionSupportOwnerBand',
            oi.productionSupportOwner?.band,
          )
          ...
          setValue(
            'applicationOwnerLeader1Name',
            oi.applicationOwnerLeader1?.fullName,
          )
          setValue(
            'applicationOwnerLeader1Email',
            oi.applicationOwnerLeader1?.email,
          )
          setValue(
            'applicationOwnerLeader1Band',
            oi.applicationOwnerLeader1?.band,
          )
          setValue(
            'businessOwnerLeader1Name',
            oi.businessOwnerLeader1?.fullName,
          )
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <Input
                          ...
                          disabled
                          className="h-8 bg-muted/50 text-xs font-semibold"
                        />
                      </div>
                      <div className="space-y-1.5">
                        ...
                        <Input
                          ...
                          placeholder="e.g. TKS"
                          className={cn(
                            'h-8 uppercase font-bold tracking-widest text-xs',
                            tlaError
                      ...
                      <div className="space-y-1.5">
                        ...
                        <Input
                          ...
                          disabled
                          className="h-8 bg-muted/50 uppercase text-[10px] font-bold"
                        />
                      </div>
                    </div>
                  </motion.div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <Input
                          ...
                          className="h-8 text-xs text-blue-600 dark:text-blue-400 font-medium"
                        />
                      </div>
