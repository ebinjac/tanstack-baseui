...
import { Eye, Pencil, RefreshCw, Trash2, MoreHorizontal, Loader2 } from 'lucide-react'
...
export function ApplicationActions({ isAdmin, isSyncing, onView, onEdit, onSync, onDelete }: ApplicationActionsProps) {
    return (
        <DropdownMenu>
