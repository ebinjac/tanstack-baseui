      ...
      <CardContent className="p-4">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xl font-bold tabular-nums truncate leading-tight">
              {value}
            </p>
...
export function InfoItem({ icon, label, value, desc }: InfoItemProps) {
  return (
    <div className="space-y-1 p-3 rounded-lg border bg-muted/20">
      ...
      <p className="text-sm font-semibold truncate select-all">
...
export function ToolItem({ icon, title, desc, link }: ToolItemProps) {
  return (
    <a
      href={link}
      className="flex items-center justify-between px-4 py-3 hover:bg-muted/30 group transition-colors"
    >
      <div className="flex items-center gap-3">
