...
export const EmptyState = memo(function EmptyState({
    ...
    return (
        <Empty className={cn(sizeClasses[size], className)}>
            <EmptyHeader>
                <EmptyMedia variant="icon" className={cn(iconSizes[size], 'bg-muted/50')}>
 ...
 */
export const EmptyStateCard = memo(function EmptyStateCard(props: EmptyStateProps) {
    return (
        <EmptyState
            {...props}
            className={cn('bg-card/10 backdrop-blur-sm border border-dashed border-border/50 rounded-3xl', props.className)}
        />
    )
})
 ...
 */
export const EmptyStateInline = memo(function EmptyStateInline(props: EmptyStateProps) {
