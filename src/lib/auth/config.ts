...
export const SESSION_CONFIG = {
  password: (process.env.SESSION_PASSWORD && process.env.SESSION_PASSWORD.length >= 32) ? process.env.SESSION_PASSWORD : "this-is-a-at-least-32-char-password-for-dev", // MUST be 32+ chars long
