    ...
    return (
        <EnsembleLayout preview={previewText}>
            <Section className="mt-[20px]">
                ...
                <Text className="text-[16px] leading-[24px] text-gray-700">
                    Great news! Your team registration request has been <strong className="text-emerald-600">approved</strong>.
                </Text>
                ...
                <Section className="bg-slate-50 border-l-4 border-emerald-500 rounded p-6 my-6">
                    ...
                    <Row className="mb-2">
                        <Column className="w-[120px]">
                            <Text className="m-0 font-semibold text-slate-700">Approved By:</Text>
                        </Column>
                        <Column>
                    ...
                    <Row className={comments ? "mb-2" : ""}>
                        <Column className="w-[120px]">
                            <Text className="m-0 font-semibold text-slate-700">Approved On:</Text>
                        </Column>
                        <Column>
                    ...
                    {comments && (
                        <Row>
                            <Column className="w-[120px]">
                                <Text className="m-0 font-semibold text-slate-700">Comments:</Text>
                            </Column>
                            <Column>
