    ...
    return (
        <EnsembleLayout preview={previewText}>
            <Section className="mt-[20px]">
                ...
                <Text className="text-[16px] leading-[24px] text-gray-700">
                    Thank you for submitting your team registration request. We have received your application and it is currently being reviewed by our operations team.
                </Text>
                ...
                <Section className="bg-slate-50 border-l-4 border-blue-500 rounded p-6 my-6">
                    ...
                    <Row className="mb-2">
                        <Column className="w-[120px]">
                            <Text className="m-0 font-semibold text-slate-700">Team Name:</Text>
                        </Column>
                        <Column>
                    ...
                    <Row>
                        <Column className="w-[120px]">
                            <Text className="m-0 font-semibold text-slate-700">Submitted On:</Text>
                        </Column>
                        <Column>
                ...
                <Text className="text-[16px] leading-[24px] text-gray-700">
                    You will receive a confirmation email once your team has been approved. In the meantime, no further action is required on your part.
                </Text>
