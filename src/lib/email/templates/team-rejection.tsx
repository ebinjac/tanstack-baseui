        ...
        <EnsembleLayout preview={previewText}>
            <Section className="mt-[20px]">
                ...
                <Section className="bg-slate-50 border-l-4 border-red-500 rounded p-6 my-6">
                    ...
                    <Row className="mb-2">
                        <Column className="w-[120px]">
                            <Text className="m-0 font-semibold text-slate-700">Reviewed By:</Text>
                        </Column>
                        <Column>
                    ...
                    <Row className={comments ? "mb-2" : ""}>
                        <Column className="w-[120px]">
                            <Text className="m-0 font-semibold text-slate-700">Reviewed On:</Text>
                        </Column>
                        <Column>
                    ...
                    {comments && (
                        <Row>
                            <Column className="w-[120px]">
                                <Text className="m-0 font-semibold text-slate-700">Reason:</Text>
                            </Column>
                            <Column>
                ...
                <Text className="text-[16px] leading-[24px] text-gray-700">
                    If you have any questions or would like more information about this decision, please reach out to the administrators.
                </Text>
