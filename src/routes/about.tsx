    ...
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary/5 via-background to-background">
      <div className="max-w-4xl mx-auto px-6 py-20 space-y-24">
        ...
        <motion.div
          ...
          className="relative rounded-3xl border border-border/50 bg-card/40 backdrop-blur-sm p-8 md:p-12 overflow-hidden"
        >
          ...
          <div className="relative space-y-6">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              ...
              <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-muted/50 border border-border/50 text-sm font-medium text-muted-foreground">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {PILLARS.map((pillar, i) => (
              <motion.div
                ...
                className="flex flex-col gap-3 p-6 rounded-2xl border border-border/50 bg-card/30 hover:bg-muted/20 transition-colors"
              >
