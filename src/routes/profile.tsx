                            ...
                            <CardContent className="flex flex-col items-center justify-center py-16 text-center space-y-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground max-w-sm mx-auto">
                                        You are not a member of any teams yet. Register a new team to get started.
                                    </p>
                                </div>
                                <Link to="/teams/register">
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex items-center gap-2 mt-1">
                                                        <Badge variant={perm.role === 'ADMIN' ? 'default' : 'secondary'} className="text-xs">
                                                            {perm.role}
                                                        </Badge>
                                                        <span className="text-xs text-muted-foreground">ID: {perm.teamId.slice(0, 8)}...</span>
                                                    </div>
                                                </div>
                                            </div>
