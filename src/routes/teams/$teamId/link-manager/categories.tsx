        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs font-bold text-muted-foreground/60 uppercase tracking-widest">Collections</span>
            </div>
                ...
                <form onSubmit={handleCreate} className="space-y-6">
                  ...
                  <div className="flex gap-3 justify-end">
                    <Button
                      type="button"
                      variant="ghost"
                      className="h-12 px-8 rounded-2xl font-bold text-xs hover:bg-muted/50 transition-colors"
                    ...
                    <Button
                      type="submit"
                      className="h-12 px-8 rounded-2xl font-bold text-xs shadow-lg shadow-primary/20"
        ...
        <div className="grid gap-4">
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-20 space-y-3">
              ...
              <p className="text-[10px] font-bold text-muted-foreground">Syncing Categories</p>
            </div>
            ...
            <div className="flex flex-col items-center justify-center py-20 bg-muted/20 border border-dashed border-border rounded-2xl text-center space-y-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground max-w-xs mx-auto">
                  {searchTerm ? `No results for "${searchTerm}".` : "Start organizing your links by creating your first category."}
                </p>
              </div>
              {!searchTerm && (
                ...
                >
                  <Card
                    className={cn(
                      ...
                      editingId === category.id ? "ring-1 ring-primary border-primary/20 bg-primary/[0.01]" : "hover:border-primary/20"
                    )}
                  >
                      ...
                      {editingId === category.id ? (
                        <div className="flex flex-col gap-3 w-full">
                          ...
                          <div className="flex gap-2 justify-end">
                            <Button size="sm" className="h-8 px-4 rounded-lg font-bold text-[11px]" onClick={() => handleUpdate(category.id)}>
                              <Check className="h-3 w-3 mr-1.5" /> Save
                            </Button>
                            <Button size="sm" variant="ghost" className="h-8 px-4 rounded-lg font-bold text-[11px]" onClick={() => setEditingId(null)}>
                              ...
                              <AlertDialogContent className="rounded-2xl p-8 max-w-sm">
                                ...
                                <AlertDialogFooter className="mt-6 gap-2">
                                  ...
                                  <AlertDialogAction
                                    ...
                                    className="h-10 px-4 rounded-xl font-bold text-xs bg-destructive hover:bg-destructive/90"
                                  >
                                    Delete
                                  </AlertDialogAction>
                                </AlertDialogFooter>
